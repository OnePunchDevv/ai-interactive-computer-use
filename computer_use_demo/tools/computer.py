...
from computer_use_demo.env_context import get_session_env_var
...
class BaseComputerTool:
    ...
    def __init__(self):
        ...
        self.width = int(get_session_env_var("WIDTH") or 0)
        self.height = int(get_session_env_var("HEIGHT") or 0)
        assert self.width and self.height, "WIDTH, HEIGHT must be set"
        if (display_num := get_session_env_var("DISPLAY_NUM")) is not None:
